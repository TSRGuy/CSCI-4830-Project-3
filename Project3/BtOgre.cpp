 ...
 */
	...
	//------------------------------------------------------------------------------------------------
	Vector3 VertexIndexToShape::getCenter()
	{
		return mCenter;
	}
	//------------------------------------------------------------------------------------------------
	...
	Vector3 VertexIndexToShape::getBoundsCenter(){
	...
	{
		Vector3 * verts = mVertexBuffer;
		Vector3 com(0,0,0);
		for(int i=0;i<mVertexCount;i++){
			com +=verts[i]/mVertexCount;
		}
		for(int i=0;i<mVertexCount;i++){
			verts[i]-=com;
		}
